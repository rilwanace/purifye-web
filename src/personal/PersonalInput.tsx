...
export default function PersonalInput({ onSaved }: { onSaved: () => void }) {
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: '#2a2a28', borderRadius: 12,
          padding: '8px 10px',
          ...
          <input
            ...
            placeholder="Tell your bot anything..."
            style={{
          ...
          <button
            ...
            disabled={loading}
            style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '4px', color: loading ? '#4a4a44' : '#9c9b95', minWidth: 32, minHeight: 32, display: 'flex', alignItems: 'center', justifyContent: 'center' }}
          >
          ...
          <button
            ...
            disabled={loading}
            style={{
              background: recording ? `${ACCENT}22` : 'none',
              border: recording ? `1px solid ${ACCENT}` : 'none',
              borderRadius: 8, cursor: 'pointer', padding: '4px', minWidth: 32, minHeight: 32,
              color: recording ? ACCENT : (loading ? '#4a4a44' : '#9c9b95'),
          ...
          {text.trim() && (
            <button
              ...
              disabled={loading}
              style={{
                background: loading ? '#2a2a28' : `linear-gradient(135deg, ${ACCENT}, #3A63B8)`,
                border: 'none', borderRadius: 8, cursor: 'pointer',
                padding: '6px 12px', color: '#fff', fontSize: 12, fontFamily: 'DM Sans', fontWeight: 600,
                minHeight: 32,
              }}
            >
              {loading ? '...' : 'Send'}
