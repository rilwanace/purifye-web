  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100dvh - 56px)", background: "#131311" }}>
      ...
      <div style={{ padding: "8px 16px 0", flexShrink: 0 }}>
        <div style={{
          background: "#1a1a18", borderRadius: 12,
          border: "1px solid rgba(255,255,255,0.06)",
          height: 38, padding: 3, display: "flex",
        }}>
          {(["entry", "history"] as Tab[]).map(tab => (
            <button
              ...
              style={{
                ...
                background: activeTab === tab ? GRAD : "transparent",
                boxShadow: activeTab === tab ? "0 0 10px rgba(93,202,165,0.2)" : "none",
                color: activeTab === tab ? "#fff" : "#6a6a64",
