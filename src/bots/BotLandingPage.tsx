...
const BOTS = [
  {
    ...
    glow: '0 8px 32px rgba(93,202,165,0.3)',
    emoji: '📊',
  },
  {
    id: 'inventory',
    ...
    glow: '0 8px 32px rgba(232,107,58,0.3)',
    emoji: '📦',
  },
  {
    id: 'social',
    ...
    glow: '0 8px 32px rgba(112,104,217,0.3)',
    emoji: '📣',
  },
  {
    id: 'customers',
    ...
    glow: '0 8px 32px rgba(207,91,160,0.3)',
    emoji: '👥',
  },
  {
    id: 'planner',
    ...
    glow: '0 8px 32px rgba(212,168,67,0.3)',
    emoji: '📅',
  },
]
  ...
  return (
    ...
    >
      <div style={{
        ...
        marginBottom: 10,
        flexShrink: 0,
        boxShadow: subscribed ? bot.glow : 'none',
        fontSize: 22,
      }}>
        {bot.emoji}
      </div>
